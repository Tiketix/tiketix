        ...
        <div className="flex gap-4">
          ...
          <div className="w-1/2 p-14">
            ...
            <div className="flex w-full gap-4">
              <button className="bg-[#003366] text-white font-bold py-4 px-3 rounded-full w-1/2 transition duration-100 hover:shadow-2xl  hover:bg-[#008080] ease-in-out">
                <Link href="/Order-Detail">Get Ticket</Link>
              </button>
      ...
      <main>
        <section className="mx-auto my-0 w-[90%]">
          <div className="flex justify-between mb-16">
            <h2 className="text-4xl mb-3 font-semibold text-[#003366]">
              Upcoming Events
            </h2>
            <ul className="flex space-x-3">
              <li className="flex">
                <Link
                  href="#"
                  className="bg-[#d1cbcb] rounded-[50px] py-3 px-5 pr-14 text-black font-medium"
                >
                  Weekdays
                </Link>
                <span className="relative top-4 right-8">
                  <FaAngleDown />
                </span>
              </li>
              <li className="flex">
        ...
        <div className="text-center my-20">
          <Link
            href="#"
            className="bg-transparent border-2 border-[#ff6600] rounded-[50px] py-5 px-[50px] font-bold transition  ease-in-out duration-300 hover:bg-[#ff6600] hover:text-white"
          >
            Load more....
          </Link>
        </div>
        ...
        <section className="flex w-full px-5 py-8 bg-[#f18b47] mb-8">
          <div className="text-center w-full text-white">
            ...
            <p>
              Are you an event organizer? Create your event and sell tickets
              with us
            </p>
            <button className="mt-8 bg-[#ffa500] rounded-[50px] w-[400px] text-center text-white p-[10px] font-extrabold cursor-pointer transition ease-in-out duration-200 shadow-lg hover:bg-[#fdba74] hover:shadow-2xl">
              Create Event
            </button>
          </div>
        </section>
